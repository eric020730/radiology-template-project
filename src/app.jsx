                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <input id="config-spreadsheet-id" type="text" placeholder="Spreadsheet ID" value={config.spreadsheetId} onChange={(e) => setConfig({...config, spreadsheetId: e.target.value})} onFocus={(e) => e.target.select()} className="flex-1 min-w-0 px-3 py-2 border rounded text-sm outline-none focus:ring-2 focus:ring-blue-500 bg-white text-black" />
                                </div>
                                <div className="flex items-center gap-3">
                                    <label htmlFor="config-api-key" className="text-sm font-medium text-slate-700 shrink-0 w-28 cursor-text">API 金鑰</label>
                                    <input id="config-api-key" type="text" placeholder="API Key" value={config.apiKey} onChange={(e) => setConfig({...config, apiKey: e.target.value})} onFocus={(e) => e.target.select()} className="flex-1 min-w-0 px-3 py-2 border rounded text-sm outline-none focus:ring-2 focus:ring-blue-500 bg-white text-black" />
                                </div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <input id="config-script-url" type="text" placeholder="Apps Script URL (Write)" value={config.scriptUrl} onChange={(e) => setConfig({...config, scriptUrl: e.target.value})} onFocus={(e) => e.target.select()} className="flex-1 min-w-0 px-3 py-2 border rounded text-sm outline-none focus:ring-2 focus:ring-blue-500 bg-white text-black" />
                                </div>
